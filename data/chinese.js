  ...
  "days": [
    ...
    },
    {
      ...
      "quiz": [
        ...
        {
          "topic": "文言",
          "q": "《咏雪》中谢道韫的\"柳絮因风起\"比\"撒盐空中\"更优，主要原因是：",
          "opts": [
            "A. 更白",
            "B. 轻盈飘舞+春意境",
            "C. 盐太咸",
      ...
      "sections": [
        {
          ...
          "problems": [
            ...
            },
            {
              ...
              "q": "下列对病句的修改不正确的一项是：",
              "opts": [
                "A. 春天的北京是个美丽的季节。→ 改为\"北京的春天是个美丽的季节\"",
                "B. 大约有30个学生左右参加了活动。→ 删去\"大约\"或\"左右\"",
                "C. 能否认真上课是取得好成绩的关键。→ 删去\"能否\"",
                "D. 他经常回忆过去的往事。→ 删去\"经常\""
              ],
              "ans": 3,
              "exp": "D修改错误。\"过去的往事\"语义重复，应删\"过去的\"或\"往\"，非\"经常\"。A搭配不当改主谓，B重复删一词，C两面对一面删能否，均为正确修改。"
            }
          ],
          "videos": [
            {
