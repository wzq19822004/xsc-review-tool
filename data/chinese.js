      ...
      "sections": [
        {
          ...
          "topic": "对联",
          "tagColor": "#f59e0b",
          "content": "<p><b>对联规则</b></p><p>①<b>字数相等</b>：上下联字数相同</p><p>②<b>词性相对</b>：名词对名词<br>动词对动词<br>例：两个黄鹂鸣翠柳 → 一行白鹭上青天</p><p>③<b>平仄相谐</b>：上联末字仄声(三四声)，下联末字平声(一二声)<br>例：春回大地(地仄) / 福满人间(间平)</p><p>④<b>内容相关</b>：上下联语意关联</p><p>⑤<b>张贴</b>：上联贴右(面门右手)<br>下联贴左</p>",
          "problems": [
            {
              "diff": "basic",
              "q": "对联上下联字数：",
      ...
      "sections": [
        {
          ...
          "topic": "传统文化",
          "tagColor": "#f59e0b",
          "content": "<p><b>一、二十四节气</b><br>春雨惊春清谷天（春）<br>夏满芒夏暑相连（夏）<br>秋处露秋寒霜降（秋）<br>冬雪雪冬小大寒（冬）<br>立春→雨水→惊蛰→春分→清明→谷雨（春）<br>立夏→小满→芒种→夏至→小暑→大暑（夏）<br>立秋→处暑→白露→秋分→寒露→霜降（秋）<br>立冬→小雪→大雪→冬至→小寒→大寒（冬）</p><p><b>二、传统节日</b>春节(贴春联)<br>元宵(赏灯吃汤圆)<br>清明(扫墓踏青)<br>端午(赛龙舟吃粽子纪念屈原)<br>中秋(赏月吃月饼)<br>重阳(登高敬老)</p><p><b>三、年龄称谓</b>总角(童年)<br>豆蔻(女13-14)<br>及笄(女15)<br>弱冠(男20)<br>而立(30)<br>不惑(40)<br>知天命(50)<br>花甲(60)<br>古稀(70)</p><p><b>四、十二生肖</b><br>子鼠 丑牛 寅虎 卯兔<br>辰龙 巳蛇 午马 未羊<br>申猴 酉鸡 戌狗 亥猪</p>",
          "problems": [
            {
              "diff": "basic",
              "q": "\"清明\"是第几个节气：",
