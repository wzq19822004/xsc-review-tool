      ...
      "sections": [
        {
          ...
          "topic": "词语运用（1）",
          "tagColor": "#f59e0b",
          "content": "<p><b>一、近义词辨析三维度</b></p><p><b>①语义轻重：</b>损坏(轻)→破坏(重)<br>批评→批判<br>失望→绝望</p><p><b>②搭配对象：</b>改善+抽象(生活/环境)改正+具体(缺点/错误)<br>发挥+能力发扬+传统</p><p><b>③感情色彩：</b>夸奖(褒)→夸耀(贬)<br>团结(褒)→勾结(贬)<br>成果(褒)→后果(贬)→结果(中)</p><p><b>【新增】常考近义词辨析</b></p><table class=\\\"grammar-table\\\"><tr><th>词组</th><th>辨析</th><th>例句</th></tr><tr><td>必须 vs 必需</td><td>必须=一定要(副词)；必需=一定需要的(形容词/动词)</td><td>我们必须遵守纪律。/ 水是生命必需的。</td></tr><tr><td>启示 vs 启事</td><td>启示=启发提示(抽象)；启事=公开声明(具体)</td><td>这本书给了我很大启示。/ 寻人启事。</td></tr><tr><td>侦察 vs 侦查</td><td>侦察=暗中观察(军事)；侦查=法律调查(公安)</td><td>侦察敌情。/ 立案侦查。</td></tr></table><p><b>二、常考易误用成语</b></p><table class=\\\"grammar-table\\\"><tr><th>成语</th><th>正确意思</th><th>常见误用</th></tr><tr><td>首当其冲</td><td>最先受到攻击/灾难</td><td>误作一马当先</td></tr><tr><td>差强人意</td><td>大体上还能使人满意</td><td>误作不满意</td></tr><tr><td>炙手可热</td><td>权势大气焰盛(贬)</td><td>误作受欢迎</td></tr><tr><td>不以为然</td><td>不认为是对的</td><td>误作不在意</td></tr><tr><td>不刊之论</td><td>不可更改的言论(褒)</td><td>误作不能刊登</td></tr><tr><td>万人空巷</td><td>形容盛大集会(家家户户都出来了)</td><td>误作没人/街道空无一人</td></tr><tr><td>七月流火</td><td>天气转凉(农历七月火星西沉)</td><td>误作天气炎热</td></tr><tr><td>文不加点</td><td>文章一气呵成不需涂改(点=涂改)</td><td>误作不加标点</td></tr><tr><td>美轮美奂</td><td>只用于形容房屋高大华美</td><td>误作一切美好</td></tr><tr><td>目无全牛</td><td>技艺极其精湛(眼中没有完整的牛只有筋骨)</td><td>误作看不到整体</td></tr></table>",
          "problems": [
            {
              "diff": "basic",
              "q": "使用正确的是：",
      ...
      "sections": [
        {
          ...
          "topic": "语言得体",
          "tagColor": "#f59e0b",
          "content": "<p><b>得体三要素：场合+对象+敬谦</b></p><p><b>①看场合</b>正式场合书面语日常用语</p><p><b>②看对象</b>对长辈用敬语对同龄可随意</p><p><b>③敬谦辞</b></p><table class=\\\"grammar-table\\\"><tr><th>敬辞</th><th>含义</th><th>谦辞</th><th>含义</th></tr><tr><td>令尊</td><td>对方父亲</td><td>家父</td><td>自己父亲</td></tr><tr><td>贵姓</td><td>对方姓</td><td>敝姓</td><td>自己姓</td></tr><tr><td>惠顾</td><td>对方光临</td><td>拜访</td><td>去见别人</td></tr><tr><td>令爱</td><td>对方女儿</td><td>拙见</td><td>自己见解</td></tr><tr><td>高见</td><td>对方见解</td><td>寒舍</td><td>自己家</td></tr><tr><td>贵庚</td><td>对方年龄</td><td>见谅</td><td>请对方原谅</td></tr><tr><td>奉还</td><td>归还对方物品</td><td>薄礼</td><td>自己的礼物</td></tr></table><p><b>④不同场合的得体表达</b></p><table class=\\\"grammar-table\\\"><tr><th>场合</th><th>得体表达</th><th>说明</th></tr><tr><td>道歉</td><td>对不起 / 请原谅 / 很抱歉</td><td>程度递增，正式场合用后者</td></tr><tr><td>感谢</td><td>谢谢 / 感激不尽 / 多亏了您</td><td>日常用\"谢谢\"，重大帮助用\"感激不尽\"</td></tr><tr><td>请求</td><td>能否麻烦您 / 请帮我 / 拜托了</td><td>对长辈用\"能否麻烦您\"</td></tr><tr><td>拒绝</td><td>恐怕不行 / 不太方便 / 改天吧</td><td>委婉拒绝，留有余地</td></tr><tr><td>询问</td><td>请问 / 请教一下 / 能否告知</td><td>对长辈用\"请教\"，对平辈用\"请问\"</td></tr></table>",
          "problems": [
            {
              "diff": "basic",
              "q": "对老师\"你听懂了吗\"不得体应改为：",
